...
class Detailed_Accepted_Orders extends StatefulWidget {
  ...
  const Detailed_Accepted_Orders({Key? key, required this.activityName, required this.price, required this.customerLocation, required this.bookingId, required this.dateTime, required this.firstName, required this.googlemapsurl, required this.phone, required this.CUSTOMERrofileImageUrl, required this.uid}) : super(key: key);

  @override
  State<Detailed_Accepted_Orders> createState() => _Detailed_Accepted_OrdersState();
}

class _Detailed_Accepted_OrdersState extends State<Detailed_Accepted_Orders> {
  @override
