...
class Detailed_Completed_Order_Customer extends StatefulWidget {
  ...
  const Detailed_Completed_Order_Customer({Key? key, required this.activityName, required this.price, required this.customerLocation, required this.bookingId, required this.dateTime, required this.firstName, required this.googlemapsurl, required this.phone, required this.CUSTOMERrofileImageUrl, required this.uid}) : super(key: key);

  @override
  State<Detailed_Completed_Order_Customer> createState() =>
      _Detailed_Completed_Order_CustomerState();
}

class _Detailed_Completed_Order_CustomerState
    extends State<Detailed_Completed_Order_Customer> {
  double _rating = 3.5;
