...
class CustomerSettingProfile extends StatefulWidget {
  static const String id = 'CustomerSettingProfile';

  CustomerSettingProfile({super.key});
  @override
  State<CustomerSettingProfile> createState() => _CustomerSettingProfileState();
}

class _CustomerSettingProfileState extends State<CustomerSettingProfile> {
        ...
        try {
          ...
          Navigator.pushReplacement<void, void>(
            ...
            MaterialPageRoute<void>(
              builder: (BuildContext context) => const Navigation_Bar(),
            ),
          );
...
// Display error text for Date selection
                              if (isDateError)
                                const Text(
