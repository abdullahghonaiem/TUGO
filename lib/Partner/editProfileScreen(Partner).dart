...
class Edit_Profile_Partner extends StatefulWidget {
  static const String id = 'Edit_Profile';

  @override
  State<Edit_Profile_Partner> createState() => _Edit_Profile_PartnerState();
}

class _Edit_Profile_PartnerState extends State<Edit_Profile_Partner> {
  final FirebaseAuth _auth = FirebaseAuth.instance;
  final FirebaseFirestore _firestore = FirebaseFirestore.instance;
  final FirebaseStorage _storage = FirebaseStorage.instance;
  final phoneController = TextEditingController();
  String countryCode = 'TR'; // Default country code, you can change it based on user data
      ...
      try {
        ...
        if (userData.exists) {
          ...
          setState(() {
            ...
            String fullPhoneNumber = userMap['phoneWithoutCountryCode'] ?? '';

            // Extract country code and phone number without country code
            countryCode = fullPhoneNumber.substring(0, 2);
            String phoneNumberWithoutCode = fullPhoneNumber.substring(2);

            phoneController.text = phoneNumberWithoutCode;
  ...
  Future<void> saveUserData() async {
    ...
    if (user != null) {
      ...
      Map<String, dynamic> updatedData = {
        ...
        'phoneWithCountryCode': '+''$countryCode$phoneValue',
        'phoneWithoutCountryCode': '$countryCode$phoneValue', // Save the phone number with country code
      ...
      try {
        ...
        Navigator.pushReplacement<void, void>(
          ...
          MaterialPageRoute<void>(
            ...
            const Navigation_Bar_Partner_Side(initialIndex: 2)
            ,
          ),
        );
      } catch (e) {
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        IntlPhoneField(
                          ...
                          onChanged: (phone) {
                            // You can handle phone number changes if needed
                          },
