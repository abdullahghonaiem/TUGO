...
class Detailed_Rejected_Orders extends StatefulWidget {
  ...
  const Detailed_Rejected_Orders({Key? key, required this.activityName, required this.price, required this.customerLocation, required this.bookingId, required this.dateTime, required this.firstName, required this.googlemapsurl, required this.phone, required this.CUSTOMERrofileImageUrl}) : super(key: key);

  @override
  State<Detailed_Rejected_Orders> createState() => _Detailed_Rejected_OrdersState();
}

class _Detailed_Rejected_OrdersState extends State<Detailed_Rejected_Orders> {
  @override
